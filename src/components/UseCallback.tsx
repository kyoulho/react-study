...
// DecrementButton 은 보통의 함수 컴포넌트로 버튼을 표시한다.
...
// IncrementButton 은 메모이제이션한 함수 컴포넌트로 버튼을 표시한다.
...
// DoubleButton 은 메모이제이션한 함수 컴포넌트로 버튼을 표시한다.
const DoubleButton = React.memo(
    (props: ButtonProps) => {
        const {onClick} = props;
